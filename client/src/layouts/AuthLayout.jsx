...
export const AuthLayout = ({ title, subtitle, children }) => {
  return (
    <div className="min-h-screen bg-(--bg) surface-grid flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md bg-(--card) border border-(--border) rounded-xl p-7 shadow-xl animate-fade-in-up">
